// Aplica a migration 20260812230000_template_base no Neon compartilhado.
...
//
// Rodar: cd /Users/weydsonlima/nerp-2 && node apply-template-base-migration.mjs
...
const migName = "20260812230000_template_base";
...
try {
  ...
  await client.query(
    `INSERT INTO "_prisma_migrations" (id, checksum, finished_at, migration_name, logs, rolled_back_at, started_at, applied_steps_count)
     VALUES (gen_random_uuid()::text, 'manual-template-base', NOW(), $1, NULL, NULL, NOW(), 1)
     ON CONFLICT DO NOTHING`,
    [migName],
  );
  await client.query("COMMIT");
  console.log(
    "OK — isBase adicionado.",
  );
} catch (e) {
