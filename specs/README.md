...
- [`catalogo-orbita.md`](./catalogo-orbita.md) — Catálogo online no modo ORBITA: pedido vai ao Órbita (Astro negocia, cobra via PIX) e volta confirmado por `catalogOrder.updateStatus` · 🟢 implementado, aguardando teste do dev
