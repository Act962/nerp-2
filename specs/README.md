...
- [`site-animacoes-astro.md`](./site-animacoes-astro.md) — Editor de animações do ASTRO em `/site/animacoes`: camadas com início/fim, cenas no Postgres e o mascote desenhado no site a partir de um momento · `feat/site-animacoes-astro` · 🟢 código pronto, aguardando teste do dev
...
- [`astro-jornadas-fase-0.md`](./astro-jornadas-fase-0.md) — o Astro ensina cada tela passo a passo com o usuário dando o clique, a empresa ganha ★ ao concluir, e o painel dele ganha o botão "Melhorias" · `feat/astro-jornadas-fase-0` · 🟡 em andamento
- [`astro-jornadas-fase-1-varejo.md`](./astro-jornadas-fase-1-varejo.md) — onze jornadas novas cobrindo o miolo do ERP de varejo: estoque, financeiro, cadastros, catálogos, caixa, pedidos, preços e o acesso da equipe · `feat/astro-jornadas-fase-0` · 🟡 em andamento
...
- [`food-fase-2-pagamento-na-hora.md`](./food-fase-2-pagamento-na-hora.md) — **(2)** PIX com QR no cardápio pelo Asaas, credencial cifrada por organização, webhook com assinatura e dedupe, e o corte "só pedido pago vai para a cozinha" · `feat/food-fase-2-pagamento-na-hora` · 📋 planejado
- [`food-fase-3-salao-e-mesas.md`](./food-fase-3-salao-e-mesas.md) — **(3)** Mesa como cadastro, grade colorida no app do garçom, QR por mesa, conta que acumula e montagem do pedido com busca + `+/-` · `feat/food-fase-3-salao-e-mesas` · 🟢 código pronto, aguardando teste do dev
