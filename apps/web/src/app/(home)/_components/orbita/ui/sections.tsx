...
import { TOOLS, TOOLS_BY_CATEGORY } from "../data/catalog";
 ...
 */
const ANGLES = toolAngles(TOOLS.length);

const CATEGORY_WINDOWS = TOOLS_BY_CATEGORY.map((category) => {
  const indexes = category.tools.map((tool) => TOOLS.indexOf(tool));
