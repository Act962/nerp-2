 ...
 * inteira em quatro colunas, uma por momento do negócio, na mesma ordem em que
 * a órbita as apresenta; "Segmentos" abre os setores atendidos, em cards.
 *
          ...
          <>
            ...
            <div className="o-mega__foot">
              <p className="o-mega__note">
                Dezenove ferramentas na mesma base: o que uma escreve, a outra
                já enxerga.
              </p>
              <button
                type="button"
