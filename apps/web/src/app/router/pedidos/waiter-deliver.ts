...
// Marca como entregue ao cliente. Exige sessão + vínculo com a organização; o
// garçom continua só alcançando os pedidos que ele mesmo atendeu.
export const waiterDeliver = base
