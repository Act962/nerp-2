...
const TOOL_PATHS: Record<string, string> = {
  ...
  /* --- os módulos da loja, e o método que orquestra tudo --- */
  pdv: "M3 8h18l-1.5 9a2 2 0 0 1-2 1.7H6.5a2 2 0 0 1-2-1.7zM8 8V6a4 4 0 0 1 8 0v2M9 12h6",
  estoque: "M3 9l9-5 9 5-9 5zM3 9v6l9 5 9-5V9M12 14v6",
  inventario:
    "M7 3h10a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2zM9 8h6M9 12h6M9 16h3",
  "catalogo-promocional": "M4 4h16v13H4zM4 17l3 3h10l3-3M8 8h8M8 12h5",
  "qr-preco":
    "M4 4h6v6H4zM14 4h6v6h-6zM4 14h6v6H4zM14 14h2v2h-2zM18 14h2v2h-2zM14 18h2v2h-2zM18 18h2v2h-2z",
  "catalogo-online": "M3 5h18v11H3zM3 16l-1 3h20l-1-3M8 9h8M8 12h5",
  planograma: "M3 4h18v16H3zM3 9.3h18M3 14.6h18M8 4v16M15 4v16",
  book: "M4 4h7a2 2 0 0 1 2 2v14a2 2 0 0 0-2-2H4zM20 4h-7a2 2 0 0 0-2 2v14a2 2 0 0 1 2-2h7z",
  trafego: "M3 18l4-6 4 3 5-8 5 4M3 21h18M17 4h4v4",
  /* O método é o ciclo: quatro estações e a volta. */
  metodo:
    "M12 3a9 9 0 1 1-6.4 2.6M12 3v3M21 12h-3M12 21v-3M3 12h3M5.6 5.6l2.1 2.1",
