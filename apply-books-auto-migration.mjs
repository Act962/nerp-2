// Aplica a migration 20260812200000_book_pages_and_slots no Neon compartilhado.
...
//
// Rodar: cd /Users/weydsonlima/nerp-2 && node apply-books-auto-migration.mjs
...
const migName = "20260812200000_book_pages_and_slots";
...
try {
  ...
  await client.query(
    `INSERT INTO "_prisma_migrations" (id, checksum, finished_at, migration_name, logs, rolled_back_at, started_at, applied_steps_count)
     VALUES (gen_random_uuid()::text, 'manual-books-auto', NOW(), $1, NULL, NULL, NOW(), 1)
     ON CONFLICT DO NOTHING`,
    [migName],
  );
  await client.query("COMMIT");
  console.log(
    "OK — book_pages criada; book_items agora aceita bookPageId + slotIndex.",
  );
} catch (e) {
