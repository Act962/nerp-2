// Aplica a migration 20260819120000_promotional_catalog_templates no Neon
...
//
// Rodar: cd /Users/weydsonlima/nerp-2 && node apply-catalog-templates-migration.mjs
...
const migName = "20260819120000_promotional_catalog_templates";
...
try {
  ...
  await client.query(
    `INSERT INTO "_prisma_migrations" (id, checksum, finished_at, migration_name, logs, rolled_back_at, started_at, applied_steps_count)
     VALUES (gen_random_uuid()::text, 'manual-catalog-templates', NOW(), $1, NULL, NULL, NOW(), 1)
     ON CONFLICT DO NOTHING`,
    [migName],
  );
  await client.query("COMMIT");
  console.log("OK — tabela promotional_catalog_templates criada.");
} catch (e) {
